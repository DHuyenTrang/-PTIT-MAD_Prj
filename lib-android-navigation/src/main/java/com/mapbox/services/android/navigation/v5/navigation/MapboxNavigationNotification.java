...
//    if (context != null) {
//      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
//        context.registerReceiver(endNavigationBtnReceiver, new IntentFilter(END_NAVIGATION_ACTION), Context.RECEIVER_VISIBLE_TO_INSTANT_APPS);
//      }
//    }
  }
...
//      // No need to update notification if exception occurs
//    }
  }
