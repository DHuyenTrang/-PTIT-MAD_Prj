package com.n3t.mobile.core.widgets.pin_view
...
class PinView @JvmOverloads constructor(
	...
	private fun drawAnchorLine(canvas: Canvas) {
		...
		mPath.lineTo(cx, mItemBorderRect.top + abs(mItemBorderRect.height()))
		canvas.drawPath(mPath, mPaint)
		mPath.reset()
		mPath.moveTo(mItemBorderRect.left, cy)
		mPath.lineTo(mItemBorderRect.left + abs(mItemBorderRect.width()), cy)
		canvas.drawPath(mPath, mPaint)
		mPath.reset()
		mPaint.strokeWidth = mLineWidth.toFloat()
	}
