package com.n3t.mobile.utils.geohash
...
open class GeoHash : Parcelable {
    ...
    private fun checkConvert() {
        if (significantBits % BASE32_BITS != 0) {
            throw IllegalStateException("Cannot convert to base32")
        }
    }
